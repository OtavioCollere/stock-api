...
describe('Decrease Quantity  (E2E)', () => {
  ...
  it("[PATCH] /products/decrease-quantity", async () => {
    ...
    const result = await supertest(app.getHttpServer()).patch('/products/decrease-quantity')
    .send({
      productId: product.id.toString(),
      sellerId: user.id.toString(),
      reason: 'Test decrease quantity',
      quantity: 5,
    })
